...
#    Updated: 2018/05/08 20:04:27 by alazarev         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = util_setter.c util_getter.c conversion_percent_pointer.c ft_printf.c util.c unicode.c conversion.c conversion_unicode.c\
	  ...
	  ft_atoi_base.c ft_itoa_base.c ft_ranknumber.c\
